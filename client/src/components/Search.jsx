  ...
  return (
    <div className="w-[100%] m-2">
      <div className="flex items-center h-10 bg-purple-400 rounded" type="text">
        {/* <select className="p-2 bg-gray-300 text-black border text-xs xl:text-sm w-fit">
        ...
        <input
  className="flex p-1 grow items-center h-[100%] rounded-l text-black hover:border-0 "
  type="text"
  value={searchInput}
  onChange={(e) => {
